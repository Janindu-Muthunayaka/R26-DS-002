...
def split_at_headlines(bls, headlines, band_x, min_pitch, p):
    ...
    **13 of the 48 that reached the column crop had a headline band sitting
    ...
    the "it reads text that is not part of the article" symptom.
    ...
    Only a headline that actually crosses the columns being read counts. One
    off to the side belongs to a story in another column.
    """
